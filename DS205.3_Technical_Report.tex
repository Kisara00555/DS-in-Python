...
\midrule
Context Relevance (LLM-as-Judge) & 77.50\% \\
Faithfulness (LLM-as-Judge) & 80.83\% \\
Answer Relevance (LLM-as-Judge) & 87.50\% \\
	extbf{RAG Score (Harmonic Mean)} & 	extbf{80.00\%} \\
\midrule
Precision (Keyword Specificity) & 50.39\% \\
Recall (Knowledge Coverage) & 42.36\% \\
F1 Score & 45.63\% \\
Cosine Similarity (Semantic Match) & 80.77\% \\
\bottomrule
\end{tabular}
...
\subsection{Ground Truth Evaluation Dataset}
The following table presents the 12 ground-truth evaluation questions, the responses generated by the RAG system, and their respective RAG Triad scores.
...
\hline
\textbf{ID} & \textbf{Question} & \textbf{Generated Response} & \textbf{RAG Score} \\
\hline
Q01 & What is venture capital and how does it differ from angel investing? & Venture capital (VC) is institutional funding provided by VC firms to high-growth startups in exchange for equity (Source: startup\_funding\_guide.pdf). VC firms manage pooled funds from Limited Partners (LPs) and typically invest larger amounts at later stages.

Angel investing is early-stage funding from individual investors (angels) using their personal capital (Source: startup\_funding\_guide.pdf). & 0.89 \\
\hline
Q02 & What are the typical stages of startup funding rounds? & Startup funding typically progresses through: 
1. Pre-seed (idea stage, friends/family/angels, < \$1M) 
2. Seed (professional investors, \$1M-\$5M) 
3. Early-stage (Series A or B, \$5M-\$20M) 
4. Late-stage (Series C or D, \$20M+)

(Source: startup\_funding\_guide.pdf) & 0.00 \\
\hline
Q03 & What was the total amount of VC funding raised globally in Q1 2026? & \$330.9B (Source: kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf) & 0.96 \\
\hline
Q04 & How much VC investment did the Americas see in Q1 2026, and how much of that was from the US? & \$270.1B in VC investment, with \$267.2B from the US (Source: [9] kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf). & 0.92 \\
\hline
Q05 & What is the difference between pre-money and post-money valuation? & Pre-money valuation is the agreed-upon value of a startup before it receives new investment capital (\$4M in the example). Post-money valuation is the pre-money valuation plus the new investment amount (\$5M in the example, \$4M + \$1M) (Source: [1] startup\_funding\_guide.pdf). & 0.89 \\
\hline
Q06 & Which sector dominated deal value and funding in the Q1 2026 report? & AI dominated deal value and funding in Q1 2026 (Source: [8] kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf). & 0.89 \\
\hline
Q07 & According to the report's criteria, how is a 'growth' round defined for a startup? & A 'growth' round is defined as Series E or later, or deals involving companies at least 7 years old and having raised at least 6 VC rounds (Source: [5] kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf). & 0.89 \\
\hline
Q08 & Why do startups typically raise capital in multiple funding rounds instead of all at once? & Startups raise capital in multiple funding rounds to minimize equity dilution for the founders (Source: [1] startup\_funding\_guide.pdf). & 0.50 \\
\hline
Q09 & How did the total global VC investment change from Q4 2025 to Q1 2026? & Global VC investment rose from \$128.6B in Q4'25 to \$330.9B in Q1'26 (Source: [2] kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf). & 1.00 \\
\hline
Q10 & How does an IPO exit differ from an acquisition (M\&A) exit strategy? & An IPO exit is when a company lists its shares on a public market (IPO, direct listing, or reverse merger via SPAC) (Source: [1] kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf). An M\&A exit is when a company is acquired by another entity (Source: [6] kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf). & 0.86 \\
\hline
Q11 & Are unicorn financings strictly limited to first-time unicorn companies? & No, unicorn financings are not strictly limited to first-time unicorn companies (Source: [4] kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf). & 0.89 \\
\hline
Q12 & What does the term 'unicorn' refer to in the startup ecosystem? & A unicorn refers to a startup with a post-money valuation of \$1 billion or more (Source: [3] kpmg-private-enterprise-venture-pulse-q1-26-global-report.pdf). & 0.89 \\
\hline
\end{tabularx}
\caption{Ground Truth Questions, Generated Responses, and RAG Scores.}
\end{table}
